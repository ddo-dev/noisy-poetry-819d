...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/noisy-poetry-819d
```

A live public deployment of this template is available at [https://noisy-poetry-819d.templates.workers.dev](https://noisy-poetry-819d.templates.workers.dev)
